...
library("shiny")
# 
# rsconnect::setAccountInfo(name='janebunr',
#                           token='47F35579E2EC71321554285E84396D47',
#                           secret='AfSJY/8e09gec0Ih6BATnr9ZrtIxhN68mR+n6N32')
# 
# library(rsconnect)
# rsconnect::deployApp('~/Documents/ShinnyTest/ShinnyCars')
...
ui <- fixedPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      tabsetPanel(
        #tabPanel("Welcome", "Welcome to Shinny app by R made specifically to do text anal,, analyze texts"),
...
negated_texts <- reactive({
  ...
  count_negatedtexts %>%   #The most common positive or negative words 
    #to follow negations such as ‘never’, ‘no’, ‘not’, and ‘without’
